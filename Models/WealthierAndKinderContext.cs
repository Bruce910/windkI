...
public partial class WealthierAndKinderContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TStockInStock>(entity =>
        {
            ...
            entity.Property(e => e.FEstProP)
                .HasColumnName("fEstProP");

            entity.Property(e => e.FLeftStock)
                .HasColumnName("fLeftStock");

            entity.Property(e => e.FStockAdj)
            ...
            entity.Property(e => e.FStockTran)
